...
public class NavbarTag extends ElementsTag {
    ...
    protected StringBuilder __doTagStart() {
        StringBuilder _classSB = new StringBuilder(StringUtils.trimToEmpty(this.get_class())).append(" navbar navbar-");
        if (inverse) {
            _classSB.append("inverse");
        } else {
            _classSB.append("default");
        }
        //
        if (staticTop) {
            _classSB.append(" navbar-static-top");
        } else if (fixedTop) {
            _classSB.append(" navbar-fixed-top");
        } else if (fixedBottom) {
            _classSB.append(" navbar-fixed-bottom");
        }
        //
    ...
    protected StringBuilder __doTagContent(StringBuilder tagContent, StringBuilder bodyContent) {
        ...
        if (StringUtils.isNotBlank(headBody) || StringUtils.isNotBlank(brand) || StringUtils.isNotBlank(collapseId)) {
            ...
            if (StringUtils.isNotBlank(collapseId)) {
                tagContent.append(" data-toggle=\"collapse\" data-target=\"#").append(collapseId).append("\"");
            }
            tagContent.append("\">");
            ...
            if (StringUtils.isNotBlank(brand)) {
                ...
                if (StringUtils.isNotBlank(href)) {
                    tagContent.append(" href=\"").append(href).append("\"");
                }
                tagContent.append(">").append(brand).append("</a>");
            }
            //
        ...
        if (emptyBody) {
            ...
            if (StringUtils.isNotBlank(collapseId)) {
                tagContent.append(" id=\"").append(collapseId).append("\"");
            }
            tagContent.append(">").append(bodyContent).append("</div>");
        }
