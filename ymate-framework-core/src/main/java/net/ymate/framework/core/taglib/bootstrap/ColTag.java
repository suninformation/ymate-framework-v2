...
public class ColTag extends ElementsTag {
    ...
    protected StringBuilder __doTagStart() {
        ...
        if (md != null && md > 0) {
            _classSB.append(" col-md-").append(md);
            if (mdOffset != null && mdOffset > 0) {
                _classSB.append(" col-md-offset-").append(mdOffset);
            }
            if (mdPush != null && mdPush > 0) {
                _classSB.append(" col-md-push-").append(mdPush);
            }
            if (mdPull != null && mdPull > 0) {
                _classSB.append(" col-md-pull-").append(mdPull);
            }
        }
        if (xs != null && xs > 0) {
            _classSB.append(" col-xs-").append(xs);
            if (xsOffset != null && xsOffset > 0) {
                _classSB.append(" col-xs-offset-").append(xsOffset);
            }
            if (xsPush != null && xsPush > 0) {
                _classSB.append(" col-xs-push-").append(xsPush);
            }
            if (xsPull != null && xsPull > 0) {
                _classSB.append(" col-xs-pull-").append(xsPull);
            }
        }
        if (sm != null && sm > 0) {
            _classSB.append(" col-sm-").append(sm);
            if (smOffset != null && smOffset > 0) {
                _classSB.append(" col-sm-offset-").append(smOffset);
            }
            if (smPush != null && smPush > 0) {
                _classSB.append(" col-sm-push-").append(smPush);
            }
            if (smPull != null && smPull > 0) {
                _classSB.append(" col-sm-pull-").append(smPull);
            }
        }
        if (lg != null && lg > 0) {
            _classSB.append(" col-lg-").append(lg);
            if (lgOffset != null && lgOffset > 0) {
                _classSB.append(" col-lg-offset-").append(lgOffset);
            }
            if (lgPush != null && lgPush > 0) {
                _classSB.append(" col-lg-push-").append(lgPush);
            }
            if (lgPull != null && lgPull > 0) {
                _classSB.append(" col-lg-pull-").append(lgPull);
            }
        }
